...
PRISM_CDN = "https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/"
PRISM_JS = f"{PRISM_CDN}prism.min.js"
PRISM_CSS = f"{PRISM_CDN}themes/prism.min.css"
PRISM_PYTHON_JS = f"{PRISM_CDN}components/prism-python.min.js"
...
async def md_to_image_async(md_text: str, output_path: str = None) -> Optional[str]:
    ...
    try:
        ...
        <head>
        <meta charset="UTF-8">
        <link href="{PRISM_CSS}" rel="stylesheet">
        <script src="{PRISM_JS}"></script>
        <script src="{PRISM_PYTHON_JS}"></script>
        <style>
